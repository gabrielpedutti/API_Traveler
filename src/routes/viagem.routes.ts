...
// import { GetViagemLoginController } from "../modules/viagem/useCases/getViagem/GetViagemController";
...
// const getViagemLoginController = new GetViagemController();
...
// viagemRoutes.post("/:id", getViagemController.handle);
